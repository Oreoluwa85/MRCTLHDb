select TSeq_orgname,TWA1,RanBPM,Rmnd5,MAEA,Muskelin,WDR26,Armc8,c17orf39 from
(
select *,
...
Order by TWA1 DESC, RanBPM DESC, Rmnd5 DESC, MAEA DESC, muskelin DESC, WDR26 DESC, Armc8 DESC, c17orf39 DESC